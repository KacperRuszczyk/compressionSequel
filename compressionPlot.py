...
st.markdown(st.download_button(label="Download File", key="download_button", on_click=None, '/mount/src/compressionsequel/work_space/results_dir/results.csv'), unsafe_allow_html=True)
